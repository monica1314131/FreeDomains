...
export function Landing() {
    return (
        <div className="flex flex-col min-h-screen w-full">
            ...
            <main className="flex-1 w-full flex flex-col bg-[#FAFAFA]">
                <HeroSection />
                ...
                <section className="w-full bg-[#FAFAFA] relative overflow-hidden z-30 pt-4 md:pt-8 pb-6 md:pb-8">
                ...
                <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 py-8">
                    ...
                    <div className="flex flex-col items-center justify-center text-center pb-24 md:pb-32 px-4 relative z-10">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight mb-6 max-w-4xl">
                        ...
                        <a 
                            href="/login" 
                            className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-black text-white font-bold text-lg hover:bg-neutral-800 transition-all duration-300 shadow-xl shadow-black/10 hover:shadow-2xl hover:shadow-black/20 hover:-translate-y-1"
                        >
                            Get Started
                        </a>
                    </div>
